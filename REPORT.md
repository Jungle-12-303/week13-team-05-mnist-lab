...
현재 구현한 모델은 두 개의 은닉층과 하나의 출력층을 통과하는 다층 퍼셉트론(MLP) 구조이다.
(28x28 이미지를 784차원 백터로 변환)
...
가장 수렴 속도가 빠르고 안정적인 Adam을 최종 옵티마이저로 채택하였고,
이번 과제에서는 목표 정확도에 도달하기 위한 기본 설정으로 사용했습니다.
